...
const LessonNavigationMobile = ({
  ...
  return (
    <>
      ...
      <Button
        className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full opacity-0 group-hover:opacity-100 transition hidden md:block"
        onClick={() =>
