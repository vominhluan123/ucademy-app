          ...
          {lectures.map((lecture: TUpdateCourseLecture) => (
            ...
            >
              <AccordionItem value={lecture._id.toString()}>
                <AccordionTrigger>
                  <div className="flex gap-3 items-center w-full justify-between mt-5">
                ...
                <AccordionContent className="!bg-transparent border-none p-0">
                  <div className="flex flex-col gap-3">
                    {lecture.lessons.map((item: any) => (
                      <div
                        key={item._id}
                        className="flex items-center gap-2 p-4 text-base rounded-lg bg-gray-200 dark:bg-dark-card dark:border-dark-card border border-gray-200"
                      >
