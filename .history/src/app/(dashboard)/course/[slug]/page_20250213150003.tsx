    ...
    <div className="grid lg:grid-cols-[2fr,1fr] gap-10">
      ...
      <div>
        <div className="bg-white rounded-lg p-5">
          ...
          <h3 className="font-bold mb-2">Khoá học gồm có:</h3>
          <ul className="mb-3 flex flex-col text-sx text-slate-500">
            <li className="flex items-center gap-2">
              <IconPlay className="size-5"></IconPlay>
              <span className="text-primary">30h học</span>
            </li>{" "}
            <li className="flex items-center gap-2">
              <IconPlay className="size-5"></IconPlay>
              <span className="text-primary">Video Full HD</span>
            </li>
            <li className="flex items-center gap-2">
              <IconUser className="size-5"></IconUser>
              <span className="text-primary">Có nhóm hỗ trợ</span>
            </li>
            <li className="flex items-center gap-2">
              <IconStudy className="size-5"></IconStudy>
              <span className="text-primary">Tài liệu kèm theo</span>
            </li>
          </ul>
