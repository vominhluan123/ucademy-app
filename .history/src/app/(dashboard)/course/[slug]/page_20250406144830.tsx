                ...
                <AccordionContent className="!bg-transparent border-none">
                  <div className="flex flex-col gap-3">
                    {lecture.lessons.map((item: any) => (
                      <div
                        key={lecture._id}
                        className="flex items-center border gap-3 mb-5 rounded-lg bg-slate-600"
                      >
                        <div className="flex-shrink-0 size-4 border border-dark-border p-1  flex items-center justify-center rounded-full">
                          <IconPlay></IconPlay>
                        </div>
                        {item.title}
                        {item.video && (
