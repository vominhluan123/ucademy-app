...
const page = async ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[2fr,1fr] gap-5 lg:gap-10 min-h-screen">
      ...
      <h2 className="font-bold text-xl mb-2 dark:text-dark-text">Thông tin</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center mb-10">
        ...
        <div className="bg-white rounded-lg p-3 md:p-5">
          <h4 className="text-sm text-slate-400 dark:text-dark">Thời lượng</h4>
