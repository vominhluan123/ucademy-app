          ...
          {lectures.map((lecture: TUpdateCourseLecture) => (
            ...
            >
              <AccordionItem value={lecture._id}>
                ...
                <AccordionContent className="bg-slate-600 border-none">
                  {lecture.lessons.map((item: any) => (
                    <div
                      key={lecture._id}
                      className="flex items-center gap-3 mb-5 rounded-lg bg-slate-600"
                    >
                      <span className="flex-shrink-0 size-4 border border-dark-border p-1  flex items-center justify-center rounded-full">
                        <IconPlay></IconPlay>
                      </span>
                      {item.title}
                      {item.video && (
