...
const layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="block lg:grid  pb-20 lg:pb-0 lg:grid-cols-[300px,minmax(0,1fr)] h-screen">
      ...
      <Sidebar></Sidebar>
      <ul className="fixed bottom-0 left-0 w-full bg-white dark:bg-dark-card dark:border-opacity-1 p-3 h-16 lg:hidden flex justify-center gap-10 z-50 shadow-md">
