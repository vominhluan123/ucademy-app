...
const CourseItem = () => {
  return (
    <div className="course-items bg-white border border-gray-200 p-4 rounded-2xl">
      ...
      <div className="py-4">
        <h3 className="font-bold text-lg mb-5">Khoá học nextjs</h3>
        <div className="flex items-center justify-between">
          <span className="text-sm bg-opacity-10 rounded-full px-3 py-1 bg-primary text-primary">
            3h1ph
          </span>
        ...
        <Link
          href="#"
          className="flex items-center justify-center h-12 text-white font-semibold bg-primary w-full mt-10"
        >
          Xem chi tiết
        </Link>
      </div>
