...
const CourseItem = ({ data }: { data: ICourse }) => {
  return (
    <div className="course-items relative bg-gray-100 dark:bg-dark-card dark:border-dark-card  border border-gray-200  p-4 rounded-2xl transition">
      {/* Ảnh khóa học */}
      <Link href={`/course/${data?.slug}`} className="block h-[300px]">
        <Image
          alt="Unsplash Image"
          src={data.image}
