  ...
  return (
    <>
      ...
      <div className="flex justify-end gap-3 mt-5">
        <button className="size-10 rounded-md flex  items-center justify-center bg-primary hover:bg-opacity-10">
          <svg
        ...
        <button className="size-10 rounded-md flex  items-center justify-center bg-primary">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            fill="currentColor"
