  ...
  return (
    <div className="course-items bg-gray-100 dark:bg-dark-card dark:border-dark-card  border border-gray-200  p-4 rounded-2xl transition">
      ...
      <div className="pt-4">
        ...
        <Link
          href="#"
          className="flex items-center justify-center h-12 text-white rounded-lg font-semibold bg-primary dark:bg-dark-border dark:hover:bg-dark-hover  hover:bg-secondary hover:shadow-lg hover:scale-105 w-full mt-10 transition-all duration-300 ease-in-out"
        >
          Xem chi tiết
        </Link>
      </div>
