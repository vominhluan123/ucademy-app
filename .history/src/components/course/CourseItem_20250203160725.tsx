    ...
    <div className="course-items bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 rounded-2xl transition">
      ...
      <div className="py-4">
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm flex items-center gap-1 rounded-full px-3 py-1 bg-primary/10 dark:bg-primary-dark/20 text-primary dark:text-primary-dark">
        ...
        <Link
          href="#"
          className="flex items-center justify-center h-12 text-white rounded-lg font-semibold bg-blue-500 dark:bg-blue-700 hover:opacity-90 w-full mt-10 transition"
        >
          Xem chi tiết
        </Link>
      </div>
