...
const CoureManage = ({ coursesData }: CoursesManageProps) => {
  const { course, totalPages, currentPage } = coursesData;
  console.log("🚀 ~ CoureManage ~ coursesData:", coursesData);
