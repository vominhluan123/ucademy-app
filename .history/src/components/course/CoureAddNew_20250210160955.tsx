          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="relative">
                ...
                <FormLabel className="absolute left-4 !top-2 text-gray-500 dark:text-gray-400 text-sm peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 !peer-focus:top-4 peer-focus:text-sm peer-focus:text-primary dark:peer-focus:text-primary-dark transition-all">
                  Tên Khoá Học *
                </FormLabel>
                <FormMessage />
              </FormItem>
