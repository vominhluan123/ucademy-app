...
const CourseItem = () => {
  return (
    <div className="course-items bg-white border border-gray-200 p-4 rounded-2xl">
      ...
      <div className="py-4">
        <h3 className="font-bold text-lg mb-3 text-primary">Khoá học nextjs</h3>
        <div className="flex items-center justify-between gap-2 mb-5">
          ...
          <div className="flex items-center gap-1  text-primary">
            <IconStart className="size-4"></IconStart>
            <span>5.0</span>
          </div>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-sm bg-opacity-10 flex items-center gap-1 rounded-full px-3 py-1 bg-primary text-primary">
