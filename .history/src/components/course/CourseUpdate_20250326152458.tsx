...
const formSchema = z.object({
  title: z.string().min(10, "Tối thiểu 10 ký tự"),
                  ...
                  <>
                    {courseInfo.requirements.map((r, index) => (
                      <div key={index} className="flex items-center w-full">
                        <Input
                          className="flex-1  py-2 font-medium border dark:bg-dark-border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white bg-transparent focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-primary-dark focus:border-primary  transition"
