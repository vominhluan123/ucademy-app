    ...
    <div className="course-items bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 rounded-2xl transition">
      ...
      <div className="py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-semibold text-primary dark:text-dark">
            3000$
          </span>
        </div>
        ...
        <Link
          href="#"
          className="flex items-center justify-center h-12 text-white rounded-lg font-semibold bg-primary dark:bg-dark hover:bg-secondary hover:shadow-lg hover:scale-100 w-full mt-10 transition-all duration-300 ease-in-out"
        >
          Xem chi tiết
        </Link>
      </div>
