                ...
                <FormControl>
                  <>
                    {courseInfo.requirements.map((r, index) => (
                      <Input
                        className="w-full mb-5 px-4 py-2 font-medium border dark:bg-dark-border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white bg-transparent focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-primary-dark focus:border-primary  transition"
                        key={index}
                        value={r}
                ...
                <FormControl>
                  <>
                    {courseInfo.benefits.map((r, index) => (
                      ...
                      >
                        <Input
                          className="flex-1 w-full mb-5 px-4 py-2 font-medium border dark:bg-dark-border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white bg-transparent focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-primary-dark focus:border-primary  transition"
