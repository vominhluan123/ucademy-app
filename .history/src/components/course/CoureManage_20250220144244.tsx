          ...
          <TableRow>
            ...
            <TableCell>
              <div className="flex gap-3">
                <button className="size-8 rounded-md dark:bg-transparent dark:bg-dark-border border flex justify-center items-center bg-gray-100 text-gray-500 hover:bg-white">
                  <IconEdit />
                </button>
              </div>
            </TableCell>
