          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="relative">
                ...
                <FormLabel className="absolute left-10 top-2 text-gray-500 dark:text-gray-400 text-sm peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-2 peer-focus:text-sm peer-focus:text-primary dark:peer-focus:text-primary-dark transition-all">
                  Đường dẫn Khoá Học
                </FormLabel>
                <FormMessage />
              </FormItem>
