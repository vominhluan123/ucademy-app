...
const Sidebar = () => {
  return (
    <Fragment>
      <div className="p-5 border-r border-r-gray-200 bg-white dark:bg-dark dark:border-dark-border text-dark-text flex flex-col">
        {/* Logo */}
        ...
        {/* User Actions */}
        <div className="mt-auto flex items-center gap-3 p-3 border-t border-gray-200 ">
          <ModeToggle />
          <UserButton />
        </div>
      </div>
