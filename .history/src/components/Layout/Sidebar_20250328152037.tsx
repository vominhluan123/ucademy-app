  ...
  return (
    <Fragment>
      <div className=" hidden p-5 border-r border-r-gray-200 bg-white dark:bg-dark-card dark:border-opacity-10 lg:flex flex-col fixed bottom-0 w-[300px] top-0 left-0 h-screen">
        ...
        {/* Menu */}
        <ul className="lg:flex-grow fixed bottom-0 left-0 w-full bg-white dark:bg-dark-card dark:border-opacity-1 p-3 h-16 lg:hidden flex justify-center gap-5 z-50 shadow-md ">
