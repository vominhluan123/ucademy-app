...
const Sidebar = () => {
  ...
  return (
    <Fragment>
      <div className=" hidden p-5 border-r pb:20 lg:pb-0 border-r-gray-200 bg-white dark:bg-dark-card dark:border-opacity-10 lg:flex flex-col fixed bottom-0 w-[300px] top-0 left-0 h-screen">
        {/* Logo */}
        <Link
          href="/"
