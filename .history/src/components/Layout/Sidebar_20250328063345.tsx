  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-5 left-5 z-50 bg-primary text-white p-2 rounded-md w-10"
      >
        ☰
      </button>
      ...
      {/* Sidebar + Overlay */}
      <div
        className={`fixed top-0 left-0 h-screen w-[300px] bg-white dark:bg-dark-card border-r border-gray-200 dark:border-opacity-10 p-5 flex flex-col transition-transform duration-300 z-[1000] 
        ${
