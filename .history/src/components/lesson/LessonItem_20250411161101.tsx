...
const LessonItem = ({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-2 p-4 text-sm rounded-lg bg-white dark:bg-dark-hover dark:border-dark-card border font-semibold border-gray-200 transition-all duration-300 ease-in-out",
        isActive
          ? " bg-muted font-semibold text-primary border-l-4 border-primary"
          : "hover:bg-muted"
      )}
    >
      {url && (
